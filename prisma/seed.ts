...
const CLIENTS: ClientSpec[] = [
  {
    name: "Rahul Sharma", email: "rahul.sharma@example.com", phone: "+91 98200 41122",
    gender: "MALE", height: 178, dob: "1994-03-18", goal: "Lose 8 kg and build visible core definition",
    planKey: "transformation", startOffset: -63, status: "ACTIVE", autoRenew: false,
    startWeight: 82, currentWeight: 76.5, startBodyFat: 24.8, currentBodyFat: 17.2,
    weeks: 9, unreviewed: 1,
    feedback: [
  ...
  {
    name: "Sarah Patel", email: "sarah.patel@example.com", phone: "+91 99303 55418",
    gender: "FEMALE", height: 165, dob: "1991-11-02", goal: "Body recomposition — leaner at the same weight",
    planKey: "coaching", startOffset: -30, status: "ACTIVE", autoRenew: true,
    startWeight: 68, currentWeight: 63.2, startBodyFat: 31.5, currentBodyFat: 25.1,
    weeks: 4, unreviewed: 0, priorPlanKey: "transformation",
    feedback: [
  ...
  {
    name: "Aarav Mehta", email: "aarav.mehta@example.com", phone: "+91 97690 20734",
    gender: "MALE", height: 172, dob: "1999-07-25", goal: "Gain 6 kg of lean mass",
    planKey: "coaching", startOffset: -21, status: "ACTIVE", autoRenew: true,
    startWeight: 61.4, currentWeight: 64.1, startBodyFat: 13.2, currentBodyFat: 14.6,
    weeks: 3, unreviewed: 0,
    feedback: [
  ...
  {
    name: "Priya Shah", email: "priya.shah@example.com", phone: "+91 98111 88240",
    gender: "FEMALE", height: 158, dob: "1988-01-14", goal: "Fat loss with a sustainable food routine",
    planKey: "nutrition", startOffset: -49, status: "ACTIVE", autoRenew: true,
    startWeight: 71, currentWeight: 67.4, startBodyFat: 35.2, currentBodyFat: 30.8,
    weeks: 7, unreviewed: 1,
    feedback: [
  ...
  {
    name: "Kabir Joshi", email: "kabir.joshi@example.com", phone: "+91 90040 71165",
    gender: "MALE", height: 181, dob: "1986-09-09", goal: "Get back to a 140 kg deadlift and lose the belly",
    planKey: "elite", startOffset: -75, status: "ACTIVE", autoRenew: true,
    startWeight: 90.2, currentWeight: 86.2, startBodyFat: 27.4, currentBodyFat: 22.9,
    weeks: 10, unreviewed: 0, overdueWeeks: 2,
    feedback: [
  ...
  {
    name: "Ananya Iyer", email: "ananya.iyer@example.com", phone: "+91 98866 30291",
    gender: "FEMALE", height: 162, dob: "1997-05-30", goal: "Build a consistent routine and lose 6 kg",
    planKey: "transformation", startOffset: -7, status: "TRIAL", autoRenew: false,
    startWeight: 74, currentWeight: 73.6, startBodyFat: 33.9, currentBodyFat: 33.4,
    weeks: 1, unreviewed: 1,
  ...
  {
    name: "Vikram Nair", email: "vikram.nair@example.com", phone: "+91 99872 14508",
    gender: "MALE", height: 175, dob: "1983-12-21", goal: "Reverse pre-diabetes markers",
    planKey: "transformation", startOffset: -98, status: "EXPIRED", autoRenew: false,
    startWeight: 95.4, currentWeight: 84.5, startBodyFat: 32.1, currentBodyFat: 24.3,
    weeks: 12, unreviewed: 0,
    feedback: [
  ...
  {
    name: "Meera Reddy", email: "meera.reddy@example.com", phone: "+91 97400 66823",
    gender: "FEMALE", height: 168, dob: "1993-08-11", goal: "Rebuild strength post-partum",
    planKey: "coaching", startOffset: -35, status: "ACTIVE", autoRenew: true,
    startWeight: 66.8, currentWeight: 64.8, startBodyFat: 30.1, currentBodyFat: 27.6,
    weeks: 5, unreviewed: 1,
    feedback: [
  ...
  {
    name: "Dev Kapoor", email: "dev.kapoor@example.com", phone: "+91 90210 47739",
    gender: "MALE", height: 169, dob: "1990-02-06", goal: "Drop 12 kg before the wedding",
    planKey: "coaching", startOffset: -14, status: "PAUSED", autoRenew: false,
    startWeight: 88.3, currentWeight: 87.1, startBodyFat: 29.8, currentBodyFat: 29.1,
    weeks: 2, unreviewed: 0,
    feedback: [
  ...
  {
    name: "Ishita Rao", email: "ishita.rao@example.com", phone: "+91 98330 90514",
    gender: "FEMALE", height: 170, dob: "1995-06-19", goal: "Sub-4-hour marathon with strength support",
    planKey: "elite", startOffset: -82, status: "ACTIVE", autoRenew: false,
    startWeight: 58.9, currentWeight: 56.4, startBodyFat: 22.4, currentBodyFat: 19.1,
    weeks: 11, unreviewed: 0, overdueWeeks: 1,
    feedback: [
  ...
  {
    name: "Rohan Desai", email: "rohan.desai@example.com", phone: "+91 99671 33802",
    gender: "MALE", height: 183, dob: "1992-10-27", goal: "Decide between fat loss and strength focus",
    planKey: "consult", startOffset: -3, status: "ACTIVE", autoRenew: false,
    startWeight: 92, currentWeight: 92, startBodyFat: 26, currentBodyFat: 26,
    weeks: 0, unreviewed: 0, feedback: [],
    notes: ["Consultation booked. Strong candidate for the 12-week transformation."],
  },
  {
    name: "Neha Bansal", email: "neha.bansal@example.com", phone: "+91 98455 27390",
    gender: "FEMALE", height: 160, dob: "1996-04-03", goal: "Fat loss without giving up home-cooked food",
    planKey: "nutrition", startOffset: -56, status: "CANCELLED", autoRenew: false,
    startWeight: 78.2, currentWeight: 75.2, startBodyFat: 36.8, currentBodyFat: 34.2,
    weeks: 6, unreviewed: 0,
    feedback: [
...
const PLANS = [
  {
    key: "transformation", name: "12 Week Transformation",
    description: "The flagship programme. Personalised training, nutrition targets, weekly check-ins and a fortnightly progress call. Built for a visible, measurable change in twelve weeks.",
    planType: "TRANSFORMATION" as PlanType, durationDays: 84, price: 15000,
    billingInterval: "ONE_TIME" as BillingInterval,
  },
  {
    key: "coaching", name: "1:1 Online Coaching",
    description: "Ongoing month-to-month coaching. Training that adapts every four weeks, nutrition guidance, weekly check-ins and unlimited async support.",
    planType: "ONE_TO_ONE_COACHING" as PlanType, durationDays: 30, price: 10000,
    billingInterval: "MONTHLY" as BillingInterval,
  },
  {
    key: "nutrition", name: "Nutrition Coaching",
    description: "Nutrition only, for clients who already have training handled. Macro targets, a practical meal framework and weekly accountability.",
    planType: "NUTRITION_COACHING" as PlanType, durationDays: 30, price: 5000,
    billingInterval: "MONTHLY" as BillingInterval,
  },
  {
    key: "elite", name: "Elite Quarterly Coaching",
    description: "Everything in 1:1 coaching plus twice-monthly video calls, priority response and quarterly programme design. Limited to twelve clients at a time.",
    planType: "ONE_TO_ONE_COACHING" as PlanType, durationDays: 90, price: 27000,
    billingInterval: "QUARTERLY" as BillingInterval,
  },
  {
    key: "consult", name: "Strategy Consultation",
    description: "A single 45-minute call. Goal audit, training and nutrition review, and a written plan of action you can run yourself.",
    planType: "CONSULTATION" as PlanType, durationDays: 7, price: 1500,
    billingInterval: "ONE_TIME" as BillingInterval,
  },
];

const WORKOUTS: Record<string, { name: string; description: string; days: { title: string; dayOfWeek: number; focus: string; exercises: [string, number, string, number, string][] }[] }> = {
  transformation: {
    name: "Transformation — Upper/Lower Split",
    description: "Four training days a week alternating upper and lower body, with progressive overload on the primary lifts and 8–10k steps on rest days.",
    days: [
      { title: "Upper Body A", dayOfWeek: 1, focus: "Push emphasis", exercises: [
      ...
      { title: "Lower Body A", dayOfWeek: 2, focus: "Squat emphasis", exercises: [
      ...
      { title: "Upper Body B", dayOfWeek: 4, focus: "Pull emphasis", exercises: [
      ...
      { title: "Lower Body B", dayOfWeek: 5, focus: "Hinge emphasis", exercises: [
  ...
  coaching: {
    ...
    description: "A three-day rotation reviewed every four weeks. Session length is 50–60 minutes, designed to fit around a full working week.",
    days: [
      { title: "Push", dayOfWeek: 1, focus: "Chest, shoulders, triceps", exercises: [
      ...
      { title: "Pull", dayOfWeek: 3, focus: "Back and biceps", exercises: [
      ...
      { title: "Legs", dayOfWeek: 5, focus: "Full lower body", exercises: [
  ...
  elite: {
    ...
    description: "Five days a week: three heavy strength sessions plus two conditioning days. Reviewed every fortnight on the progress call.",
    days: [
      { title: "Max Effort Lower", dayOfWeek: 1, focus: "Heavy squat / deadlift", exercises: [
      ...
      { title: "Max Effort Upper", dayOfWeek: 2, focus: "Heavy press / pull", exercises: [
      ...
      { title: "Conditioning", dayOfWeek: 3, focus: "Zone 2 + intervals", exercises: [
      ...
      { title: "Repetition Upper", dayOfWeek: 5, focus: "Volume and hypertrophy", exercises: [
      ...
      { title: "Accessory & Mobility", dayOfWeek: 6, focus: "Hips, core, shoulders", exercises: [
...
const DIETS: Record<string, { name: string; description: string; kcal: number; p: number; c: number; f: number; meals: [string, string, string, number, number][] }> = {
  transformation: {
    name: "Transformation Nutrition — Moderate Deficit",
    description: "A 500 kcal deficit built around Indian home cooking. Protein is the non-negotiable; carbs sit around training. Two flexible meals a week are built in on purpose.",
    kcal: 2200, p: 160, c: 220, f: 70,
    meals: [
      ["Breakfast", "7:30 – 8:30 AM", "4 egg whites + 2 whole eggs, 2 multigrain rotis, a bowl of curd. Black coffee if you want it.", 480, 38],
      ["Lunch", "1:00 – 2:00 PM", "150 g grilled chicken or 200 g paneer, 1 cup rice, dal, a large salad with lemon.", 700, 52],
      ["Pre-workout", "5:00 – 5:30 PM", "1 banana with a scoop of whey, or a fruit-and-oats bowl.", 300, 28],
      ["Dinner", "8:30 – 9:30 PM", "Grilled fish or rajma, 2 rotis, sautéed vegetables in 1 tsp ghee.", 620, 42],
      ["Optional", "Anytime", "100 g Greek yoghurt if you are still hungry. Do not skip meals to save calories.", 100, 10],
    ],
  },
  coaching: {
    name: "Coaching Nutrition — Maintenance Plus",
    description: "Calories set just above maintenance to support training while keeping body composition steady. Adjusted every four weeks based on your check-in trend.",
    kcal: 2450, p: 170, c: 260, f: 75,
    meals: [
      ["Breakfast", "8:00 – 9:00 AM", "Oats with milk, whey and berries. Add peanut butter if calories are low.", 550, 42],
  ...
  nutrition: {
    ...
    description: "A vegetarian-first framework designed around what is already cooked at home. No separate meals, no exotic ingredients — portion structure does the work.",
    kcal: 1750, p: 120, c: 165, f: 55,
    meals: [
      ["Breakfast", "7:30 – 8:30 AM", "Moong dal chilla with curd, or poha with peanuts and a glass of milk.", 420, 26],
      ["Lunch", "1:00 – 2:00 PM", "2 rotis, dal, 100 g paneer or tofu sabzi, salad first.", 580, 38],
      ["Snack", "5:00 PM", "Roasted chana or a whey shake. Tea without sugar.", 250, 25],
      ["Dinner", "8:00 – 9:00 PM", "Vegetable khichdi with curd, or soya keema with one roti.", 500, 31],
    ],
  },
  elite: {
    name: "Elite Nutrition — Performance Fuelling",
    description: "Periodised around the training week: carbs are pushed towards the heavy days and pulled back on rest days. Hydration and sodium targets included.",
    kcal: 2800, p: 190, c: 320, f: 80,
    meals: [
      ["Breakfast", "7:00 – 8:00 AM", "5 eggs, 3 slices sourdough, avocado, black coffee.", 700, 45],
      ...
      ["Before bed", "10:30 PM", "Casein or curd. 3 litres water across the day, salt your food.", 200, 20],
    ],
  },
};
...
const GYMS: GymSpec[] = [
  {
    ...
    amenities: ["Powerlifting racks", "Cardio floor", "Personal training", "Showers", "Parking", "Air conditioned"],
  ...
  },
  {
    ...
    extraMembers: [
      {
        name: "Tanvi Deshpande", email: "tanvi.deshpande@example.com", phone: "+91 98450 33110",
        gender: "FEMALE", height: 163, dob: "1996-02-12", goal: "Build strength and stop lower-back pain",
        planKey: "coaching", startOffset: -56, status: "ACTIVE", autoRenew: true,
        startWeight: 64.2, currentWeight: 62.1, startBodyFat: 29.4, currentBodyFat: 26.2,
        weeks: 8, unreviewed: 1,
        feedback: [
        ...
        notes: ["Physio cleared her for loaded hinging. Keep progression slow.", "Very consistent — good candidate for the PT upsell."],
      },
      {
        name: "Karthik Nambiar", email: "karthik.nambiar@example.com", phone: "+91 98450 33111",
        gender: "MALE", height: 177, dob: "1991-09-04", goal: "Get back under 80 kg",
        planKey: "coaching", startOffset: -84, status: "ACTIVE", autoRenew: true,
        startWeight: 88.6, currentWeight: 82.3, startBodyFat: 28.9, currentBodyFat: 23.1,
        weeks: 12, unreviewed: 0, overdueWeeks: 1,
        feedback: [
          "Down another kilo. Trousers are loose.",
          "Travel week — managed hotel gym three times.",
          "Best month so far. Sleep is the difference.",
        ],
        notes: ["Responds well to step targets over cardio sessions.", "Renewal conversation due in three weeks."],
      },
      {
        name: "Ritika Agarwal", email: "ritika.agarwal@example.com", phone: "+91 98450 33112",
        gender: "FEMALE", height: 158, dob: "1999-11-27", goal: "First pull-up and general conditioning",
        planKey: "nutrition", startOffset: -28, status: "ACTIVE", autoRenew: false,
        startWeight: 57.8, currentWeight: 56.9, startBodyFat: 27.1, currentBodyFat: 25.4,
        weeks: 4, unreviewed: 1,
        feedback: ["Band-assisted pull-ups are getting easier.", "Eating enough protein is still the hard part."],
        notes: ["Nutrition-only for now. Wants to add training in the new year."],
      },
      {
        name: "Sameer Bhatt", email: "sameer.bhatt@example.com", phone: "+91 98450 33113",
        gender: "MALE", height: 182, dob: "1987-06-15", goal: "Stay healthy around a desk job",
        planKey: "coaching", startOffset: -14, status: "TRIAL", autoRenew: false,
        startWeight: 93.1, currentWeight: 92.4, startBodyFat: 30.2, currentBodyFat: 29.8,
        weeks: 2, unreviewed: 1,
        feedback: ["Two sessions done. Sore but good.", "Learning the lifts. Form work mostly."],
        notes: ["Trial ends soon — send the annual offer."],
      },
      {
        name: "Divya Menon", email: "divya.menon@example.com", phone: "+91 98450 33114",
        gender: "FEMALE", height: 166, dob: "1994-04-08", goal: "Half marathon in April",
        planKey: "coaching", startOffset: -119, status: "EXPIRED", autoRenew: false,
        startWeight: 60.4, currentWeight: 57.8, startBodyFat: 25.6, currentBodyFat: 21.3,
        weeks: 14, unreviewed: 0,
        feedback: ["Race done — 1:58. Thank you!", "Taper week, feeling fresh."],
        notes: ["Finished her block. Win-back for the off-season programme."],
      },
      {
        name: "Aditya Rane", email: "aditya.rane@example.com", phone: "+91 98450 33115",
        gender: "MALE", height: 174, dob: "2000-01-19", goal: "Put on 8 kg of muscle",
        planKey: "coaching", startOffset: -42, status: "ACTIVE", autoRenew: true,
        startWeight: 58.9, currentWeight: 62.4, startBodyFat: 12.8, currentBodyFat: 14.9,
        weeks: 6, unreviewed: 0,
        feedback: ["Eating is a full-time job but the scale is moving.", "Bench up 10 kg since starting."],
        notes: ["Classic hardgainer. Hold calories even if fat gain shows."],
      },
      {
        name: "Pooja Salvi", email: "pooja.salvi@example.com", phone: "+91 98450 33116",
        gender: "FEMALE", height: 161, dob: "1989-08-23", goal: "Consistency after a long break",
        planKey: "nutrition", startOffset: -21, status: "PAUSED", autoRenew: false,
        startWeight: 70.2, currentWeight: 69.6, startBodyFat: 32.8, currentBodyFat: 32.1,
        weeks: 3, unreviewed: 0,
  ...
  },
  {
    ...
    extraMembers: [
      {
        name: "Nikhil Verma", email: "nikhil.verma@example.com", phone: "+91 98111 22334",
        gender: "MALE", height: 176, dob: "1993-03-30", goal: "Lose 10 kg before the wedding",
        planKey: "coaching", startOffset: -18, status: "ACTIVE", autoRenew: true,
        startWeight: 89.4, currentWeight: 87.1, startBodyFat: 29.6, currentBodyFat: 28.2,
        weeks: 3, unreviewed: 1,
        feedback: ["Three sessions every week so far.", "Cutting out the evening snacking was the big one."],
        notes: ["Motivated and on a deadline. Keep the wins visible."],
      },
      {
        name: "Shreya Kapadia", email: "shreya.kapadia@example.com", phone: "+91 98111 22335",
        gender: "FEMALE", height: 160, dob: "1997-12-05", goal: "Tone up and build a habit",
        planKey: "coaching", startOffset: -11, status: "ACTIVE", autoRenew: false,
        startWeight: 61.7, currentWeight: 61.2, startBodyFat: 28.3, currentBodyFat: 27.9,
        weeks: 2, unreviewed: 1,
      ...
      {
        name: "Manav Chitale", email: "manav.chitale@example.com", phone: "+91 98111 22336",
        gender: "MALE", height: 171, dob: "1985-07-14", goal: "Manage blood pressure",
        planKey: "consult", startOffset: -5, status: "ACTIVE", autoRenew: false,
        startWeight: 84.5, currentWeight: 84.5, startBodyFat: 27.4, currentBodyFat: 27.4,
        weeks: 0, unreviewed: 0, feedback: [],
...
async function seedGym(spec: GymSpec, passwordHash: string) {
  const gym = await db.gym.create({
    data: {
      ...
      storeSetupAt:
        spec.storeReady
          ? daysFromToday(-spec.foundedDaysAgo + 1)
          : null,
      listed: true,
      status: spec.status,
  ...
  for (const [index, m] of roster.entries()) {
    ...
    const cycleDays =
      plan.billingInterval === "MONTHLY" ? 30 : plan.billingInterval === "QUARTERLY" ? 90 : plan.durationDays;
    const cycles =
...
const UNCLAIMED: {
  ...
  },
  {
    ...
    views: 231,
    links: [
      { kind: "INSTAGRAM" as GymLinkKind, url: "https://instagram.com/coastlinecrossfit", clicks: 74 },
    ],
  },
  {
    code: "IRONBANK-2277",
    ...
    links: [
      ...
      { kind: "INSTAGRAM" as GymLinkKind, url: "https://instagram.com/ironbankstrength", clicks: 122 },
    ],
  },
  {
    code: "DESERT-6640",
  ...
  },
  {
    ...
    links: [
      { kind: "INSTAGRAM" as GymLinkKind, url: "https://instagram.com/boroughbarbell", clicks: 134 },
      { kind: "MAPS" as GymLinkKind, url: "https://maps.google.com/?q=Borough+Barbell+Brooklyn", clicks: 45 },
    ],
  },
  {
    code: "HARBOUR-4408",
    ...
    links: [
      { kind: "WEBSITE" as GymLinkKind, url: "https://harbourathletic.com.au", clicks: 103 },
    ],
  },
  {
    code: "SHAKTI-8804",
...
const PIN_ONLY: {
...
}[] = [
  {
    ...
    links: [
      { kind: "INSTAGRAM", url: "https://instagram.com/grindhousejaipur", label: "See the floor", clicks: 129 },
  ...
  },
  {
    ...
    links: [
      { kind: "WEBSITE", url: "https://northsidebarbell.ca", label: "Membership info", clicks: 112 },
...
async function main() {
  ...
  for (const spec of GYMS) {
    ...
    const timetable: [string, number, string, number, number, string][] = [
      ...
      ["Mobility & Core", 3, "07:30", 45, 16, "Hips, shoulders and everything that seizes up at a desk."],
